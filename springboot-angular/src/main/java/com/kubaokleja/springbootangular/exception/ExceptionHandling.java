...
import static com.kubaokleja.springbootangular.constant.UserImplConstant.userValidationFieldMap;
...
public class ExceptionHandling {
    ...
    public ResponseEntity<HttpResponse>  validationError(MethodArgumentNotValidException exception) {
        LOGGER.error(exception.getMessage());
